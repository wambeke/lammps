...
libname = name of lib dir (e.g. atc, h5md, milady, poems, etc)
...
make lib-milady args="-m mpi_gfortran -e gfortran"  # build USER-MILADY lib with gfortran
"""
...
if has_extramake and extraflag:
    lines = open("Makefile.lammps.%s" % suffix,'r').readlines()
...
if extraflag and not os.path.exists("Makefile.lammps"):
    print("lib/%s/Makefile.lammps was NOT created" % lib)
else:
    print("lib/%s/Makefile.lammps was created" % lib)
